...
public class JFontChooser extends JComponent {
    ...
    /**
     * Método estático que construye e inicializa la clase JFontChooser para
     * presentar al usuario el dialogo de selección de fuente.
     *
...
class FontChooserDialog extends JDialog {
     ...
     *
     * Construye una ventana modal de dialogo sobre una ventana padre. El
     * usuario puede seleccionar un fuente.
     *
     * @param owner la ventana padre
     * @param title
     * @param jFontChooser
    ...
    public FontChooserDialog(Frame owner, String title, final JFontChooser jFontChooser) {
        /**
         * invoca el constructor de la superclase para establecer la ventana
         * padre, el título de la ventana, y que será una ventana modal
         */
    ...
    /**
     * Retorna el fuente seleccionado por el usuario. Es el producto resultante
     * de la elección de un tipo, un estilo y un tamaño
     *
     * @return el fuente seleccionado.
     */
    public Font getSelectedFont() {
     ...
     * necesarias para atender y manejar los eventos sobre la ventana de
     * selección de fuente.
     */
    class EventHandler extends KeyAdapter implements Comparator<String>,
        ...
        public void keyReleased(KeyEvent ke) {
            ...
            if (eventTField == textFieldNames) {    //si el campo de texto es textFieldNames
                ...
                if (index > -1) {    //si el índice es mayor que -1
                    /**
                     * realiza una búsqueda binaria sobre el arreglo de nombres
                     * de fuente, se utiliza esta clase como comparador
                     * implementando la interface Comparator
                     */
        ...
        /**
         * Comparación lexicográfica de dos cadenas de texto ignorando
         * mayúsculas.
         *
        ...
        /**
         * Atiende y maneja los eventos de selección en las listas de la
         * ventana.
         *
